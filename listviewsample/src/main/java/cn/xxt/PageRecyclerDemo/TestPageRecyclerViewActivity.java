package cn.xxt.PageRecyclerDemo;
...
public class TestPageRecyclerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_page_recycler_view);
        initData();
        ...
        mRecyclerView.setAdapter(myAdapter = mRecyclerView.new PageAdapter(dataList, new PageRecyclerView.CallBack() {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(TestPageRecyclerViewActivity.this).
                        inflate(R.layout.test_page_recyclerview_item, parent, false);
            ...
            public void onItemClickListener(View view, int position) {
                Toast.makeText(TestPageRecyclerViewActivity.this, "点击："
                        + dataList.get(position), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onItemLongClickListener(View view, int position) {
                Toast.makeText(TestPageRecyclerViewActivity.this, "删除："
                        + dataList.get(position), Toast.LENGTH_SHORT).show();
