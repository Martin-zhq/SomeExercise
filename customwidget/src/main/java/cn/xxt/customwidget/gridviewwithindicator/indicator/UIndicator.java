package cn.xxt.customwidget.gridviewwithindicator.indicator;
...
public class UIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    /** 指示器样式三 选中方形，未选中圆点 */
    public static final int STYLE_CIRCLE_RECT = 2;
    ...
    /** 指示器样式，默认都是圆点 */
    private int mStyle = STYLE_CIRCLE_CIRCLE;
    ...
    private void init(AttributeSet attrs) {
        ...
        mStyle = ta.getInt(R.styleable.Indicator_style, STYLE_CIRCLE_CIRCLE);
